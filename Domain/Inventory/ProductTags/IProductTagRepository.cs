...
public interface IProductTagRepository
{
    ...
    public Task<ImmutableArray<ProductTag>> Add(IEnumerable<ProductTag> productTags, CancellationToken cancellationToken = default(CancellationToken));

    public Task Delete(ProductTag productTag, CancellationToken cancellationToken = default(CancellationToken));
    public Task Delete(int productId, int id, CancellationToken cancellationToken = default(CancellationToken));
    ...
    public Task DeleteByProducts(IEnumerable<int> productIds, CancellationToken cancellationToken = default(CancellationToken));

    public Task<ProductTag?> Get(int productId, int id, CancellationToken cancellationToken = default(CancellationToken));
